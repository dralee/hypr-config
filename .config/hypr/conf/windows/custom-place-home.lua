-- custom window place in workspaces by home
...
hl.window_rule({
    ...
    workspace = 5,
    match = {        
        initial_class = "(jetbrains-idea|spotify|org.telegram.desktop|jetbrains-goland|jetbrains-rustrover|jetbrains-studio|firefox|jetbrains-gateway|org.telegram)"
    }
})
hl.window_rule({
    name = "workspace6",
...
hl.window_rule({
    ...
    workspace = 8,
    match = {
        initial_class = "(microsoft-edge|cmus-player)"
