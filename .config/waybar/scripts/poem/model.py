...
class ParagraphModel:
    ...
    @staticmethod
    def from_dict(dict):
        return ParagraphModel(dict['id'], dict['content'], dict['sort'])
...
class NoteModel:
    ...
    @staticmethod
    def from_dict(dict):
        return NoteModel(dict['id'], dict['content'], dict['sort'])
...
class PoemModel:
    ...
    def to_dict(self):
        return {
            ...
            'paragraphs': [p.to_dict() for p in self.paragraphs] if self.paragraphs is not None else None,
            'notes': [n.to_dict() for n in self.notes] if self.notes is not None else None,
    ...
    @staticmethod
    def from_dict(dict):
        p = PoemModel(dict['id'],dict['title'],dict['author_id'],dict['author'],dict['rhythmic'],\
            dict['category_id'],dict['category'],dict['content_type'],dict['dynasty'],\
            [ParagraphModel.from_dict(p) for p in dict['paragraphs']] if dict['paragraphs'] is not None else None,
            [NoteModel.from_dict(n) for n in dict['notes']] if dict['notes'] is not None else None)
        return p
